...
const AddSchool = () => {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      formData.append("image", data.image[0]); // file from input
  ...
  return (
    <div style={{ maxWidth: "500px", margin: "20px auto", padding: "20px", border: "1px solid #ddd", borderRadius: "8px" }}>
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <input type="tel" placeholder="Contact Number" {...register("contact", { required: "Contact is required", pattern: { value: /^[0-9]{10}$/, message: "10 digits required" } })} />
